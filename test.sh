...
apply_codebase_fixes() {
    ...
    if grep -q "return 0" Scripts/AudioTemplates/install_musicgen.py 2>/dev/null && grep -q "sys.exit(main())" Scripts/AudioTemplates/install_musicgen.py 2>/dev/null; then
    ...
    for recipe_file in Scripts/Recipes/Models/*/*/*; do
